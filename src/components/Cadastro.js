...
export default function Cadastro(props){
    ...
    return(
        ...
        <input  type='password' placeholder="confirm password" onChange={e => setUsuario({...usuario, confirmPassword: e.target.value})} disabled={props.habilitado}></input>

        <Button onClick={() => {
            setEntrar('')
            props.setHabilitado(true)
            axios.post(`${process.env.REACT_APP_API_URL}/users`, usuario).then(()=>  {
